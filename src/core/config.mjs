...
export const MAX_RECOMMENDED_POLL_AFTER_MS = 60 * 1000;
export const DEFAULT_FOREGROUND_WAIT_CAP_MS = 50 * 1000;
export const DEEP_THINKING_POLL_AFTER_MS = MAX_RECOMMENDED_POLL_AFTER_MS;
