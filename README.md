...
```bash
npm i -g github:louchi1984-coder/deepseek-claude-code-worker-mcp#v0.3.20-beta.27
```
...
```bash
npx github:louchi1984-coder/deepseek-claude-code-worker-mcp#v0.3.20-beta.27 --doctor
```
